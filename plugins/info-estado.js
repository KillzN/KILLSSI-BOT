...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Tussi
  ${tradutor.texto1[2]} +5491122461521
  ...
  const Message = {
    document: { url: `https://github.com/Tussi` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/Tussi",
        mediaType: 2,
        previewType: "pdf",
        title: "𝗞𝗜𝗟𝗟𝗦𝗦𝗜 𝗕𝗢𝗧",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://github.com/Tussi",
      },
    },
    caption: info,
    footer: wm,
